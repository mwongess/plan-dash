...
const MoreOptions: React.FC<{ project: IProject,setShowMoreDetails:React.Dispatch<React.SetStateAction<boolean>> }>  = ({project, setShowMoreDetails}) => {
